...
@interface LiveRoomSettingResolutionView ()
...
@implementation LiveRoomSettingResolutionView
...
- (UIButton *)backButton {
    if (!_backButton) {
        ...
        [_backButton setImage:[UIImage imageNamed:@"InteractiveLive_setting_back" bundleName:HomeBundleName] forState:UIControlStateNormal];
